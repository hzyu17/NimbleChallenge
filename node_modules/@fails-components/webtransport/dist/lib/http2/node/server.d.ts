...
export class Http2WebTransportServer {
    ...
    serverInt: import("http2").Http2SecureServer;
    capsParser: WebSocketParser;
    /**
     * @param {import("http2").IncomingHttpHeaders} header
     */
    checkProtocolHeader(header: import("http2").IncomingHttpHeaders): any;
    startServer(): void;
    stopServer(): void;
    /**
     ...
     */
    finishSessionRequest({ header, userData, session: stream, status, protocol, head, path, transportPrivate }: import('../../types.js').NativeFinishSessionRequest): void;
}
